...
<template>
  <nuxt-link :to="`/producto/${product.id}`" class="relative flex items-end justify-center w-48 h-56 rounded-md shadow-xl md:w-56 md:h-64 hover:shadow-2xl">
    ...
    <div class="flex flex-col p-2 space-y-3">
      ...
      <a-button
        class="px-2 py-1 text-sm font-bold uppercase rounded-md text-begonia-sec-gray bg-begonia-primary-purple"
